...
# Decklists for easy copypaste and experimentation (uncomment and recomment multiple lines via ctrl + 3 or cmd + 3)

# No Def Soldier Build
# ZeroMachinex 3
# Kepler 3
# Gryphon 3
# Scale 3
...
# Scale AND Orthros
# Scane AND Scale
# DefenseSoldier AND Coper
# DefenseSoldier AND Orthros
# DefenseSoldier AND Scale
# DefenseSoldier AND Gryphon
# ZKC AND Gryphon
# ZKC AND Scale
# ZKC AND Orthros
# ZKC AND Coper
